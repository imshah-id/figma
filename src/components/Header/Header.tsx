  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col xl:pt-4">
        <h1 className="mb-0.5 text-xl font-bold tracking-tight text-text-primary md:text-2xl lg:text-3xl xl:mb-1 xl:text-[30px] xl:leading-[36px]">
      ...
      <div className="hidden items-center xl:pt-4 gap-3 xl:flex">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="flex items-center justify-center gap-2.5 rounded-[16.4px] bg-black px-6 py-3 text-sm font-medium text-white shadow-lg transition-all hover:shadow-xl"
        >
          <Sparkles size={18} />
